...
if len(known_embeddings.shape) == 1:
    known_embeddings = known_embeddings.reshape(1, -1)

if known_embeddings.size == 0:
    raise ValueError("Known embeddings are empty. Please check the embeddings file.")
...
for test_embedding in test_embeddings:
    ...
    predicted_label = 1 if max_similarity > 0.8 else 0
